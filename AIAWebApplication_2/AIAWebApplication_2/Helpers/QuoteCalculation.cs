   ...
   public class QuoteCalculation
    {
     ...
     public List<decimal> driverCostFinal = new List<decimal>();
     public List<decimal> vehicleCostFinal = new List<decimal>();
     public List<string> driverNames;
     public List<long> driverId = new List<long>();
     public List<long> vehicleId = new List<long>(); 
     ...
     public decimal calcQuote(Quote quote, List<Driver> drivers, List<Vehicle> vehicles)
        ...
        public List<decimal> driverCost()
        {
